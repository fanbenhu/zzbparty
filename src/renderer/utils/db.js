...
// jk108.cn||DELETE FROM USER;
//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
db.serialize(() => {
  /**
   * 党代表信息表 USER
   * id ID
  ...
  db.run(`INSERT INTO ADMIN (id,admin_name,admin_pass,salt_key,mobile,admin_level,party_id,create_time,update_time) VALUES(1,'root','d73df577e9d7f8869c3e1e71cb92176c','SywFu6HDRrBSWoVp','15255013894','','0','1638709986667',0)`,err => {
    logger(err)
  })
